...
const FeaturedProject = ({ type, title, summary, img, link, github }: any) => {
    ...
    return (
        <article className='w-full flex items-center justify-between rounded-3xl border border-solid rounded-br-2xl border-dark bg-light shadow-2xl p-12 relative dark:bg-dark dark:border-light
            lg:flex-col lg:p-8 xs:rounded-2xl  xs:rounded-br-3xl xs:p-4 
        '>
            <div className='absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2.5rem] rounded-br-3xl bg-dark dark:bg-dark  dark:border-light xs:-right-2 sm:h-[102%] xs:w-full xs:rounded-[1.5rem]' />
...
const page = () => {
    return (
        <section className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
